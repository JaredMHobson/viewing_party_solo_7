...
# create Parties
ViewingParty.create!(duration: rand(180..240), date: Faker::Date.forward(days: rand(1..14)), start_time: Time.new.strftime("%H:%M"), movie_id: 767)
...
ViewingParty.create!(duration: rand(180..240), date: Faker::Date.forward(days: rand(1..14)), start_time: Time.new.strftime("%H:%M"), movie_id: 7446)
...
UserParty.create!(viewing_party: ViewingParty.second, user: User.first, host: false)
...
UserParty.create!(viewing_party: ViewingParty.last, user: User.third, host: false)
